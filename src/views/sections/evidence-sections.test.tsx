...
describe("EvidencePanel — runtime-rail coverage (A1, A4)", () => {
  it("A1: a rail-covered component shows per-framework asserted facts incl. non-default mechanisms", () => {
    // Progress is rail-covered with a non-default `value` fact (config bus + fixture).
    ...
    // non-default: R/V/S/L via config bus (4), Angular via fixed fixture (1)
    expect(screen.getAllByText("asserted (config bus)")).toHaveLength(4);
