 ...
 * literal-HTML doctrine for the svelte package's emitted runtime + component.
 */
...
async function mountRoot(source: string): Promise<HTMLElement> {
  const { container } = render(Markdown as unknown as Component<Record<string, unknown>>, {
