...
type ChipType = "button" | "submit" | "reset";
type ChipVariant = "default" | "selected" | "dismissible";
...
<span class={classes} data-fsds-component="chip" data-fsds-box="">
