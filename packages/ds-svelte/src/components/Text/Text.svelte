...
type TextVariant = "display" | "headline" | "title" | "body" | "caption" | "overline" | "code";
...
<svelte:element this={as ?? "p"} class={classes} data-truncate={(truncate ? "true" : "false")} data-fsds-component="text" data-fsds-box=""></svelte:element>
