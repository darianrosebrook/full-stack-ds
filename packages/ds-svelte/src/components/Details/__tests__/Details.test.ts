...
describe("Details — accessibility", () => {
  it("has no unexpected axe violations with default props", async () => {
    const { container } = render(Details as unknown as Component<Record<string, unknown>>, { props: { "summary": "placeholder", "aria-label": "Test Details", "children": createRawSnippet(() => ({ render: () => "<span>content</span>" })), "open": true } });
