...
export const dividerTokenScopes = {
  "root": {
    "box-model.padding": {
    ...
    "divider.size.thickness": {
      ...
      cssVar: "--fsds-divider-size-thickness",
...
export function resolveDividerTokens(theme?: FsdsTheme) {
  return resolveComponentTokens(dividerTokenScopes, theme);
}
// @generated:end
