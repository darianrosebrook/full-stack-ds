...
describe("Tooltip React Native", () => {
  it("opens the anchored surface from the trigger interaction", () => {
    const seen: boolean[] = [];
  let renderer: ReactTestRenderer | undefined;
  act(() => {
    renderer = TestRenderer.create(<Tooltip onOpenChange={(next: boolean) => seen.push(next)} content="Surface body" testID="subject">Anchor</Tooltip>);
  });
