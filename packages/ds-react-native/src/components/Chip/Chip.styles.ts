...
export function createChipStyles(theme?: FsdsTheme) {
  ...
  return StyleSheet.create({
    ...
    dismiss: {},
    icon: {},
    icon_variant_large: definedStyle({ width: (tokens.variant_large?.["chip.text.size"] as number | undefined), height: (tokens.variant_large?.["chip.text.size"] as number | undefined) }),
    icon_variant_medium: definedStyle({ width: (tokens.variant_medium?.["chip.text.size"] as number | undefined), height: (tokens.variant_medium?.["chip.text.size"] as number | undefined) }),
    icon_variant_small: definedStyle({ width: (tokens.variant_small?.["chip.text.size"] as number | undefined), height: (tokens.variant_small?.["chip.text.size"] as number | undefined) }),
    root: { paddingTop: (tokens.root?.["box-model.padding-block-start"] as number | undefined), paddingBottom: (tokens.root?.["box-model.padding-block-end"] as number | undefined), minHeight: (tokens.root?.["box-model.min-height"] as number | undefined), paddingLeft: (tokens.root?.["box-model.padding-inline-start"] as number | undefined), paddingRight: (tokens.root?.["box-model.padding-inline-end"] as number | undefined), gap: (tokens.root?.["box-model.gap"] as number | undefined), minWidth: (tokens.root?.["box-model.min-width"] as number | undefined), backgroundColor: (tokens.root?.["chip.color.background.default"] as string | undefined), borderColor: (tokens.root?.["chip.color.border.default"] as string | undefined), borderWidth: (tokens.root?.["chip.size.border"] as number | undefined), borderRadius: (tokens.root?.["chip.size.radius"] as number | undefined) },
