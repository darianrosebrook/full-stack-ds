...
export function createAlertStyles(theme?: FsdsTheme) {
  ...
  return StyleSheet.create({
    ...
    rootText_variant_inline: definedStyle({ fontSize: (tokens.variant_inline?.["alert.text.size"] as number | undefined) }),
    rootText_variant_page: definedStyle({ fontSize: (tokens.variant_page?.["alert.text.size"] as number | undefined) }),
    rootText_variant_section: definedStyle({ fontSize: (tokens.variant_section?.["alert.text.size"] as number | undefined) }),
    ...
    root_variant_inline: definedStyle({ gap: (tokens.variant_inline?.["alert.spacing.gap"] as number | undefined) }),
    root_variant_page: definedStyle({ gap: (tokens.variant_page?.["alert.spacing.gap"] as number | undefined) }),
    root_variant_section: definedStyle({ gap: (tokens.variant_section?.["alert.spacing.gap"] as number | undefined) }),
