...
import { resolveRadioGroupTokens } from "./RadioGroup.tokens";
// @generated:end

// @generated:start styles
export function createRadioGroupStyles(theme?: FsdsTheme) {
  const tokens = resolveRadioGroupTokens(theme);
...
export const styles = createRadioGroupStyles();
// @generated:end
