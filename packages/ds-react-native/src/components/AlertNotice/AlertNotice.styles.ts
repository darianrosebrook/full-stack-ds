...
export function createAlertNoticeStyles(theme?: FsdsTheme) {
  ...
  return StyleSheet.create({
    ...
    rootText_variant_inline: definedStyle({ fontSize: (tokens.variant_inline?.["alert-notice.text.size"] as number | undefined) }),
    rootText_variant_page: definedStyle({ fontSize: (tokens.variant_page?.["alert-notice.text.size"] as number | undefined) }),
    rootText_variant_section: definedStyle({ fontSize: (tokens.variant_section?.["alert-notice.text.size"] as number | undefined) }),
