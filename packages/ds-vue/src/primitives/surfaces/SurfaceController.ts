...
export interface SurfaceLifecycle {
  /** Called by the Vue adapter on mount / when configuration changes. */
  mount(): void;
  /** Called by the Vue adapter on unmount / before remounting. */
  unmount(): void;
}
 ...
 * consumer (Vue component); the controller is a stateless-ish bridge
