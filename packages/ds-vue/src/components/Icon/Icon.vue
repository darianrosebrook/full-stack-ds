...
<template>
  <span :class="classNames" :role="(props.decorative ? 'presentation' : 'img')" :aria-hidden="(props.decorative ? 'true' : 'false')" :aria-label="props.ariaLabel" :data-testid="props.dataTestid" data-fsds-component="icon" data-fsds-box="">
