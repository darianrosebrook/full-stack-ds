...
<template>
  <span :class="classNames" :role="(props.decorative ? 'presentation' : 'img')" :aria-hidden="(props.decorative ? 'true' : 'false')" :aria-label="props.ariaLabel" :data-testid="props['data-testid']" data-fsds-component="icon" data-fsds-box="">
