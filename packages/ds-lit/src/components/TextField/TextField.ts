...
export class TextFieldElement extends LitElement {
  static override styles = css`
    ...
    .text-field__field {
      ...
      border-color: var(--fsds-text-field-color-input-border, #aeaeae);
      border-width: var(--fsds-text-field-border-width, 1px);
      border-radius: var(--fsds-text-field-border-radius, 8px);
      color: var(--fsds-text-field-color-input-text, #141414);
      font-size: var(--fsds-text-field-typography-field-size, 1rem);
      line-height: var(--fsds-text-field-typography-field-line-height, 1.5);
      min-height: var(--fsds-text-field-field-min-height, 36px);
      padding-block: var(--fsds-text-field-field-padding-block, 8px);
      padding-inline: var(--fsds-text-field-field-padding-inline, 12px);
    ...
    .text-field__description {
      ...
      color: var(--fsds-text-field-color-supporting-text, #717171);
    }
    ...
    .text-field__error {
      ...
      font-size: var(--fsds-text-field-typography-supporting-size, 0.875rem);
      line-height: var(--fsds-text-field-typography-supporting-line-height, 1.5);
      color: var(--fsds-text-field-color-error, #d9292b);
    }

    .text-field__field::placeholder {
      color: var(--fsds-text-field-color-input-placeholder, #717171);
    }

    .text-field__field:hover:not(:disabled) {
      border-color: var(--fsds-text-field-color-input-borderHover, #8f8f8f);
    }

    .text-field__field:focus-visible {
      border-color: var(--fsds-text-field-focus-ring-color, #0a65fe);
      outline-width: var(--fsds-text-field-focus-ring-width, 2px);
      outline-color: var(--fsds-text-field-focus-ring-color, #0a65fe);
    ...
    .text-field--invalid .text-field__field {
      border-color: var(--fsds-text-field-color-input-borderError, #d9292b);
    }

    .text-field--invalid .text-field__field:focus-visible {
      border-color: var(--fsds-text-field-color-input-borderError, #d9292b);
      outline-color: var(--fsds-text-field-color-input-borderError, #d9292b);
    }

    .text-field__field:disabled {
      background-color: var(--fsds-text-field-color-input-backgroundDisabled, #efefef);
      border-color: var(--fsds-text-field-color-input-borderDisabled, #cecece);
      color: var(--fsds-text-field-color-input-textDisabled, #717171);
