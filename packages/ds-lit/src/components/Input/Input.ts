...
export class InputElement extends LitElement {
  static override styles = css`
    ...
    .input {
      ...
      min-height: var(--fsds-input-size-height-default, 36px);
      ...
      border-color: var(--fsds-input-color-border-default, #aeaeae);
      border-radius: var(--fsds-input-size-radius-default, 8px);
      font-size: var(--fsds-input-typography-size-default, 1rem);
      line-height: var(--fsds-input-typography-line-height-default, 1.5);
      padding-block: var(--fsds-input-size-padding-block-default, 8px);
      padding-inline: var(--fsds-input-size-padding-inline-default, 12px);
      ...
      &::placeholder {
        color: var(--fsds-input-color-text-placeholder, #717171);
      }

      &:hover {
        border-color: var(--fsds-input-color-border-hover, #8f8f8f);
      }

      &:focus-visible {
        border-color: var(--fsds-input-color-focus-default, #d9292b);
        outline-width: var(--fsds-input-focus-ring-width, 2px);
        outline-color: var(--fsds-input-focus-ring-color, #0a65fe);
        outline-style: var(--fsds-input-focus-ring-style, solid);
        outline-offset: var(--fsds-input-focus-ring-offset, 2px);
      }

      &:disabled {
        background-color: var(--fsds-input-color-bg-disabled, #efefef);
        border-color: var(--fsds-input-color-border-disabled, #cecece);
        color: var(--fsds-input-color-text-disabled, #717171);
    ...
    .input--invalid {
      border-color: var(--fsds-input-color-invalid-default, #ae0001);
    }
