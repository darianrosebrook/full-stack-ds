...
export class PopoverElement extends LitElement {
  static override styles = css`
    ...
    [data-popover-content] {
      ...
      background-color: var(--fsds-popover-color-background-content, #ffffff);
      border-color: var(--fsds-popover-color-border-default, #d0d0d0);
  ...
  override connectedCallback(): void {
    ...
    this.setAttribute("data-fsds-component", "popover");
...
export class PopoverContentElement extends LitElement {
  ...
  // the walk to the PopoverElement provider would fail — but
  ...
  private _ctxCache: PopoverSurfaceContext | null = null;
