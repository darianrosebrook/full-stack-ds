...
export class CodeSnippetElement extends LitElement {
  static override styles = css`
    ...
    .code-snippet {
      ...
      background-color: var(--fsds-code-snippet-color-background-default, #efefef);
      border-color: var(--fsds-code-snippet-color-border-default, #cecece);
      border-style: solid;
      border-width: var(--fsds-code-snippet-size-border-default, 1px);
      border-radius: var(--fsds-code-snippet-size-radius-default, 8px);
