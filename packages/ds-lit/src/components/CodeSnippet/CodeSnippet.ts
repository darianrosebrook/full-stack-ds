...
export class CodeSnippetElement extends LitElement {
  ...
  override render() {
    return html`${this.as === "kbd" ? html`<kbd class="${this.computeClasses()}" spellcheck="false" data-fsds-box="">${this.text}</kbd>` : this.as === "samp" ? html`<samp class="${this.computeClasses()}" spellcheck="false" data-fsds-box="">${this.text}</samp>` : html`<code class="${this.computeClasses()}" spellcheck="false" data-fsds-box="">${this.text}</code>`}`;
  }
}
