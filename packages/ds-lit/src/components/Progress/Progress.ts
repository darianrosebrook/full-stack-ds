...
export class ProgressElement extends LitElement {
  ...
  override render() {
    return html`<div class="${this.computeClasses()}" role="progressbar" aria-valuenow=${ifDefined(this.value)} aria-valuemin="0" aria-valuemax="100" aria-label=${ifDefined(this.label)} data-fsds-box="">
