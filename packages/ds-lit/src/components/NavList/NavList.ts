...
export class NavListElement extends LitElement {
  static override styles = css`
    ...
    .nav-list__list {
      ...
      gap: var(--fsds-nav-list-size-gap-list, 2px);
      list-style: none;
      margin: 0;
      padding: 0;
    }
    ...
    .nav-list__item {
      display: block;
      color: var(--fsds-nav-list-color-foreground-default, #555555);
      padding-block: var(--fsds-nav-list-size-padding-block, 4px);
      padding-inline: var(--fsds-nav-list-size-padding-inline, 8px);
      border-radius: var(--fsds-nav-list-size-radius-default, 8px);
