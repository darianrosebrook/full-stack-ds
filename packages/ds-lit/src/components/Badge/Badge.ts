...
export class BadgeElement extends LitElement {
  static override styles = css`
    ...
    .badge {
      ...
      min-height: var(--fsds-badge-size-min-height, 24px);
      ...
      padding-block: var(--fsds-badge-size-padding-y, 2px);
      padding-inline: var(--fsds-badge-size-padding-x, 8px);
      font-size: var(--fsds-badge-size-font-size, 12px);
