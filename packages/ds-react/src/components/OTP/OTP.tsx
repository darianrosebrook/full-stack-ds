...
export function OTP({
  ...
  return (
  <Stack layout="native" className={`${classNames}`} role="group" aria-label={label} aria-describedby={ariaDescribedby} data-testid={testId} data-fsds-component="otp" data-fsds-box="" {...rest}>
