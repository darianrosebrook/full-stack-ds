 ...
 * literal-HTML doctrine for the react package's emitted runtime + component.
 */
...
function mountRoot(source: string): HTMLElement {
  render(<Markdown data-testid="md-root" content={source} />);
  return screen.getByTestId("md-root");
}
