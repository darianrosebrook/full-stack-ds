...
enum OTPTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "otp.color.background.default": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-color-background-default", name: "otp.color.background.default", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            "otp.color.foreground.primary": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-color-foreground-primary", name: "otp.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "otp.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-color-border-default", name: "otp.color.border.default", fallback: .adaptive(light: "#b8b8b8", dark: "#474647")),
            "otp.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-size-padding-default", name: "otp.size.padding.default", fallback: .string("24px")),
            "otp.size.radius.default": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-size-radius-default", name: "otp.size.radius.default", fallback: .string("6px")),
            "otp.color.border.accent": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-color-border-accent", name: "otp.color.border.accent", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "otp.focus.ring.width": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-focus-ring-width", name: "otp.focus.ring.width", fallback: .string("2px")),
            "otp.focus.ring.color": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-focus-ring-color", name: "otp.focus.ring.color", fallback: .adaptive(light: "#0566fe", dark: "#0566fe")),
            "otp.focus.ring.style": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-focus-ring-style", name: "otp.focus.ring.style", fallback: .string("solid")),
            "otp.focus.ring.offset": FsdsComponentTokenDefinition(cssVar: "--fsds-otp-focus-ring-offset", name: "otp.focus.ring.offset", fallback: .string("2px")),
        ],
    ]
}
