...
enum TruncateTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "truncate.color.foreground.link": FsdsComponentTokenDefinition(cssVar: "--fsds-truncate-color-foreground-link", name: "truncate.color.foreground.link", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "truncate.color.background.primary": FsdsComponentTokenDefinition(cssVar: "--fsds-truncate-color-background-primary", name: "truncate.color.background.primary", fallback: .adaptive(light: "#ffffff", dark: "#000000")),
            "truncate.typography.fontWeight": FsdsComponentTokenDefinition(cssVar: "--fsds-truncate-typography-font-weight", name: "truncate.typography.fontWeight", fallback: .string("500")),
            "truncate.spacing.toggle": FsdsComponentTokenDefinition(cssVar: "--fsds-truncate-spacing-toggle", name: "truncate.spacing.toggle", fallback: .string("2px")),
            "truncate.color.foreground.linkHover": FsdsComponentTokenDefinition(cssVar: "--fsds-truncate-color-foreground-link-hover", name: "truncate.color.foreground.linkHover", fallback: .adaptive(light: "#b31b1b", dark: "#ee8181")),
        ],
    ]
}
