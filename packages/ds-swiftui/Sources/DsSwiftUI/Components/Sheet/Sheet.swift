...
enum SheetTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "sheet.color.background": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-background", name: "sheet.color.background", fallback: .string("#ffffff")),
            "sheet.color.border": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-border", name: "sheet.color.border", fallback: .string("#b8b8b8")),
            "sheet.color.text": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-text", name: "sheet.color.text", fallback: .string("#141414")),
            "sheet.color.textTitle": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-text-title", name: "sheet.color.textTitle", fallback: .string("#141414")),
            "sheet.color.textDescription": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-text-description", name: "sheet.color.textDescription", fallback: .string("#474647")),
