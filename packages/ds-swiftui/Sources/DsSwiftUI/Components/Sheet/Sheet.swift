...
enum SheetTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "sheet.color.overlay": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-overlay", name: "sheet.color.overlay", ref: "semantic.overlay.scrim.medium", fallback: .string("rgba(0,0,0,0.40)")),
            ...
            "sheet.color.text": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-text", name: "sheet.color.text", ref: "semantic.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "sheet.color.textTitle": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-text-title", name: "sheet.color.textTitle", ref: "semantic.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "sheet.color.textDescription": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-color-text-description", name: "sheet.color.textDescription", ref: "semantic.color.foreground.secondary", fallback: .adaptive(light: "#474647", dark: "#a0a0a1")),
            "sheet.border.width": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-border-width", name: "sheet.border.width", ref: "semantic.shape.control.border.defaultWidth", fallback: .string("1px")),
            ...
            "sheet.size.close": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-size-close", name: "sheet.size.close", ref: "core.spacing.size.06", fallback: .string("16px")),
            "sheet.spacing.padding": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-spacing-padding", name: "sheet.spacing.padding", ref: "core.spacing.size.06", fallback: .string("16px")),
            "sheet.spacing.gap": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-spacing-gap", name: "sheet.spacing.gap", ref: "core.spacing.size.04", fallback: .string("8px")),
            "sheet.text.size": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-text-size", name: "sheet.text.size", ref: "semantic.typography.body.02", fallback: .string("16px")),
            "sheet.text.sizeTitle": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-text-size-title", name: "sheet.text.sizeTitle", ref: "semantic.typography.heading.06", fallback: .string("14px")),
            "sheet.text.weightTitle": FsdsComponentTokenDefinition(cssVar: "--fsds-sheet-text-weight-title", name: "sheet.text.weightTitle", ref: "semantic.typography.font.weight.medium", fallback: .string("500")),
