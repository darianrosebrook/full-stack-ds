...
enum ShuttleTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "shuttle.color.background.default": FsdsComponentTokenDefinition(cssVar: "--fsds-shuttle-color-background-default", name: "shuttle.color.background.default", ref: "semantic.color.background.secondary", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            ...
            "shuttle.color.border.accent": FsdsComponentTokenDefinition(cssVar: "--fsds-shuttle-color-border-accent", name: "shuttle.color.border.accent", ref: "semantic.color.border.accent", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "shuttle.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-shuttle-size-padding-default", name: "shuttle.size.padding.default", ref: "core.spacing.size.07", fallback: .string("24px")),
