...
enum ListTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "list.color.foreground.primary": FsdsComponentTokenDefinition(cssVar: "--fsds-list-color-foreground-primary", name: "list.color.foreground.primary", fallback: .string("#141414")),
            "list.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-list-color-border-default", name: "list.color.border.default", fallback: .string("#d0d0d0")),
