...
enum ListTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "list.color.foreground.primary": FsdsComponentTokenDefinition(cssVar: "--fsds-list-color-foreground-primary", name: "list.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "list.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-list-color-border-default", name: "list.color.border.default", fallback: .adaptive(light: "#d0d0d0", dark: "#474647")),
            "list.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-list-size-padding-default", name: "list.size.padding.default", fallback: .string("16px")),
            "list.size.sm": FsdsComponentTokenDefinition(cssVar: "--fsds-list-size-sm", name: "list.size.sm", fallback: .string("14px")),
            "list.size.md": FsdsComponentTokenDefinition(cssVar: "--fsds-list-size-md", name: "list.size.md", fallback: .string("16px")),
            "list.size.lg": FsdsComponentTokenDefinition(cssVar: "--fsds-list-size-lg", name: "list.size.lg", fallback: .string("18px")),
            "list.spacing.none": FsdsComponentTokenDefinition(cssVar: "--fsds-list-spacing-none", name: "list.spacing.none", fallback: .string("0px")),
            "list.spacing.sm": FsdsComponentTokenDefinition(cssVar: "--fsds-list-spacing-sm", name: "list.spacing.sm", fallback: .string("8px")),
            "list.spacing.md": FsdsComponentTokenDefinition(cssVar: "--fsds-list-spacing-md", name: "list.spacing.md", fallback: .string("12px")),
            "list.spacing.lg": FsdsComponentTokenDefinition(cssVar: "--fsds-list-spacing-lg", name: "list.spacing.lg", fallback: .string("24px")),
        ],
    ]
}
