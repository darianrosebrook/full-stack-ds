...
enum BreadcrumbsTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "breadcrumbs.color.foreground.primary": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-color-foreground-primary", name: "breadcrumbs.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "breadcrumbs.color.background.elevated": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-color-background-elevated", name: "breadcrumbs.color.background.elevated", fallback: .adaptive(light: "#ffffff", dark: "#141414")),
            "breadcrumbs.color.border.subtle": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-color-border-subtle", name: "breadcrumbs.color.border.subtle", fallback: .adaptive(light: "#d0d0d0", dark: "#474647")),
            "breadcrumbs.typography.lineHeight.collapse": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-typography-line-height-collapse", name: "breadcrumbs.typography.lineHeight.collapse", fallback: .string("1")),
            "breadcrumbs.shape.radius.medium": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-shape-radius-medium", name: "breadcrumbs.shape.radius.medium", fallback: .string("6px")),
            "breadcrumbs.spacing.gap.default": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-spacing-gap-default", name: "breadcrumbs.spacing.gap.default", fallback: .string("8px")),
            "breadcrumbs.spacing.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-spacing-padding-default", name: "breadcrumbs.spacing.padding.default", fallback: .string("8px")),
            "breadcrumbs.color.focus": FsdsComponentTokenDefinition(cssVar: "--fsds-breadcrumbs-color-focus", name: "breadcrumbs.color.focus", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
        ],
    ]
}
