...
enum ShowMoreTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "show-more.color.background.default": FsdsComponentTokenDefinition(cssVar: "--fsds-show-more-color-background-default", name: "show-more.color.background.default", ref: "semantic.color.background.secondary", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            ...
            "show-more.color.foreground.secondary": FsdsComponentTokenDefinition(cssVar: "--fsds-show-more-color-foreground-secondary", name: "show-more.color.foreground.secondary", ref: "semantic.color.foreground.secondary", fallback: .adaptive(light: "#474647", dark: "#a0a0a1")),
            ...
            "show-more.color.border.accent": FsdsComponentTokenDefinition(cssVar: "--fsds-show-more-color-border-accent", name: "show-more.color.border.accent", ref: "semantic.color.border.accent", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "show-more.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-show-more-size-padding-default", name: "show-more.size.padding.default", ref: "core.spacing.size.07", fallback: .string("24px")),
            ...
            "show-more.overlay.imageOverlay": FsdsComponentTokenDefinition(cssVar: "--fsds-show-more-overlay-image-overlay", name: "show-more.overlay.imageOverlay", ref: "semantic.color.background.image.overlay", fallback: .string("rgba(0, 0, 0, 0.5)")),
        ],
    ]
}
