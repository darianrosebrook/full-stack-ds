...
enum CardTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "card.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-card-color-background-hover", name: "card.color.background.hover", ref: "semantic.color.background.hover", fallback: .adaptive(light: "#f7f7f7", dark: "#474647")),
