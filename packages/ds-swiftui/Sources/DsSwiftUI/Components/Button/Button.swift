...
enum ButtonTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "button.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-hover", name: "button.color.background.hover", fallback: .string("#d0d0d0")),
            "button.color.background.active": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-active", name: "button.color.background.active", fallback: .string("#b8b8b8")),
            "button.color.background.disabled": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-disabled", name: "button.color.background.disabled", fallback: .string("#b8b8b8")),
            "button.color.foreground.default": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-foreground-default", name: "button.color.foreground.default", fallback: .string("#fafafa")),
            "button.color.foreground.disabled": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-foreground-disabled", name: "button.color.foreground.disabled", fallback: .string("#727272")),
            "button.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-border-default", name: "button.color.border.default", fallback: .string("#b8b8b8")),
            "button.color.border.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-border-hover", name: "button.color.border.hover", fallback: .string("#888889")),
            "button.color.border.focus": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-border-focus", name: "button.color.border.focus", fallback: .string("#0566fe")),
        ...
        "variant_secondary": [
            "button.color.background.default": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-default", name: "button.color.background.default", fallback: .string("#fafafa")),
            "button.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-hover", name: "button.color.background.hover", fallback: .string("#d0d0d0")),
            "button.color.background.active": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-active", name: "button.color.background.active", fallback: .string("#b8b8b8")),
            "button.color.background.disabled": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-disabled", name: "button.color.background.disabled", fallback: .string("#b8b8b8")),
            "button.color.foreground.default": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-foreground-default", name: "button.color.foreground.default", fallback: .string("#141414")),
            "button.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-border-default", name: "button.color.border.default", fallback: .string("#a0a0a1")),
        ],
        "variant_tertiary": [
