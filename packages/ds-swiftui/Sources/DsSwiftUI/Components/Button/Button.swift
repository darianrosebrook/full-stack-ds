...
enum ButtonTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "button.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-hover", name: "button.color.background.hover", ref: "semantic.interaction.background.hover", fallback: .adaptive(light: "#f7f7f7", dark: "#313131")),
            "button.color.background.active": FsdsComponentTokenDefinition(cssVar: "--fsds-button-color-background-active", name: "button.color.background.active", ref: "semantic.interaction.background.active", fallback: .adaptive(light: "#d0d0d0", dark: "#474647")),
