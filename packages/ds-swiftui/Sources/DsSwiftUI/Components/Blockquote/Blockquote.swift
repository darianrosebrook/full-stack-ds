...
enum BlockquoteTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "blockquote.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-padding-default", name: "blockquote.size.padding.default", ref: "core.spacing.size.05", fallback: .string("12px")),
            "blockquote.size.padding.sm": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-padding-sm", name: "blockquote.size.padding.sm", ref: "core.spacing.size.04", fallback: .string("8px")),
            "blockquote.size.padding.lg": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-padding-lg", name: "blockquote.size.padding.lg", ref: "core.spacing.size.07", fallback: .string("24px")),
            ...
            "blockquote.size.border.thick": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-border-thick", name: "blockquote.size.border.thick", ref: "semantic.shape.control.border.focusWidth", fallback: .string("2px")),
            "blockquote.size.fontSize.sm": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-font-size-sm", name: "blockquote.size.fontSize.sm", ref: "core.typography.ramp.3", fallback: .string("0.875rem")),
            "blockquote.size.fontSize.md": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-font-size-md", name: "blockquote.size.fontSize.md", ref: "core.typography.ramp.4", fallback: .string("1rem")),
        ...
        "variant_sm": [
            "blockquote.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-padding-default", name: "blockquote.size.padding.default", ref: "blockquote.size.padding.sm", fallback: .string("8px")),
            "blockquote.size.fontSize.md": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-font-size-md", name: "blockquote.size.fontSize.md", ref: "blockquote.size.fontSize.sm", fallback: .string("0.875rem")),
        ],
        "variant_md": [
            "blockquote.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-padding-default", name: "blockquote.size.padding.default", ref: "core.spacing.size.05", fallback: .string("12px")),
            "blockquote.size.fontSize.md": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-font-size-md", name: "blockquote.size.fontSize.md", ref: "core.typography.ramp.4", fallback: .string("1rem")),
        ...
        "variant_lg": [
            "blockquote.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-padding-default", name: "blockquote.size.padding.default", ref: "blockquote.size.padding.lg", fallback: .string("24px")),
            "blockquote.size.fontSize.md": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-font-size-md", name: "blockquote.size.fontSize.md", ref: "blockquote.size.fontSize.lg", fallback: .string("1.125rem")),
        ],
    ]
}
