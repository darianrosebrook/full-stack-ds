...
enum BlockquoteTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "blockquote.size.border.accent": FsdsComponentTokenDefinition(cssVar: "--fsds-blockquote-size-border-accent", name: "blockquote.size.border.accent", ref: "core.spacing.size.03", fallback: .string("4px")),
