...
enum FieldTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "field.color.bg": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-bg", name: "field.color.bg", fallback: .string("#ffffff")),
            "field.color.fg": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-fg", name: "field.color.fg", fallback: .string("#141414")),
            "field.color.border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-border", name: "field.color.border", fallback: .string("#d0d0d0")),
            "field.color.borderBold": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-border-bold", name: "field.color.borderBold", fallback: .string("#888889")),
            "field.color.focus-border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-focus-border", name: "field.color.focus-border", fallback: .string("#0566fe")),
            "field.color.invalid-border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-invalid-border", name: "field.color.invalid-border", fallback: .string("#b31b1b")),
        ...
        "variant_valid": [
            ...
            "field.color.fg": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-fg", name: "field.color.fg", fallback: .string("#497f21")),
        ],
        "variant_invalid": [
            "field.color.border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-border", name: "field.color.border", fallback: .string("#b31b1b")),
            "field.color.fg": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-fg", name: "field.color.fg", fallback: .string("#d92d2e")),
        ],
    ]
}
