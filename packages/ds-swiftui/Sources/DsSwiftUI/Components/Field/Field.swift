...
enum FieldTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "field.gap.y": FsdsComponentTokenDefinition(cssVar: "--fsds-field-gap-y", name: "field.gap.y", ref: "semantic.spacing.density.compact.sm", fallback: .string("8px")),
            "field.gap.meta": FsdsComponentTokenDefinition(cssVar: "--fsds-field-gap-meta", name: "field.gap.meta", ref: "core.spacing.size.03", fallback: .string("4px")),
            ...
            "field.pad.x": FsdsComponentTokenDefinition(cssVar: "--fsds-field-pad-x", name: "field.pad.x", ref: "semantic.spacing.density.compact.md", fallback: .string("12px")),
            "field.pad.y": FsdsComponentTokenDefinition(cssVar: "--fsds-field-pad-y", name: "field.pad.y", ref: "semantic.spacing.density.compact.sm", fallback: .string("8px")),
            ...
            "field.color.borderBold": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-border-bold", name: "field.color.borderBold", ref: "semantic.color.border.bold", fallback: .adaptive(light: "#888889", dark: "#727272")),
            "field.color.focus-border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-focus-border", name: "field.color.focus-border", ref: "semantic.color.border.focus", fallback: .adaptive(light: "#0566fe", dark: "#0089fe")),
            "field.color.invalid-border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-invalid-border", name: "field.color.invalid-border", ref: "semantic.color.border.danger", fallback: .adaptive(light: "#b31b1b", dark: "#d92d2e")),
            "field.color.invalid-text": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-invalid-text", name: "field.color.invalid-text", ref: "semantic.color.foreground.danger", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "field.color.valid-border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-valid-border", name: "field.color.valid-border", ref: "semantic.color.feedback.border.success", fallback: .string("#3a6614")),
            "field.color.validating-border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-validating-border", name: "field.color.validating-border", ref: "semantic.color.border.accent", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "field.color.validating-text": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-validating-text", name: "field.color.validating-text", ref: "semantic.color.foreground.secondary", fallback: .adaptive(light: "#474647", dark: "#a0a0a1")),
            "field.color.valid-text": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-valid-text", name: "field.color.valid-text", ref: "semantic.color.foreground.success", fallback: .adaptive(light: "#497f21", dark: "#5b973c")),
            "field.spacing.indicator": FsdsComponentTokenDefinition(cssVar: "--fsds-field-spacing-indicator", name: "field.spacing.indicator", ref: "core.spacing.size.03", fallback: .string("4px")),
            "field.label.fontSize": FsdsComponentTokenDefinition(cssVar: "--fsds-field-label-font-size", name: "field.label.fontSize", ref: "semantic.typography.body.small.font.size", fallback: .string("14px")),
            "field.label.color": FsdsComponentTokenDefinition(cssVar: "--fsds-field-label-color", name: "field.label.color", ref: "semantic.color.foreground.secondary", fallback: .adaptive(light: "#474647", dark: "#a0a0a1")),
            "field.focus.ring.width": FsdsComponentTokenDefinition(cssVar: "--fsds-field-focus-ring-width", name: "field.focus.ring.width", ref: "semantic.focus.ring.width", fallback: .string("2px")),
            "field.focus.ring.color": FsdsComponentTokenDefinition(cssVar: "--fsds-field-focus-ring-color", name: "field.focus.ring.color", ref: "semantic.focus.ring.color", fallback: .adaptive(light: "#0566fe", dark: "#0566fe")),
            "field.focus.ring.style": FsdsComponentTokenDefinition(cssVar: "--fsds-field-focus-ring-style", name: "field.focus.ring.style", ref: "semantic.focus.ring.style", fallback: .string("solid")),
            "field.focus.ring.offset": FsdsComponentTokenDefinition(cssVar: "--fsds-field-focus-ring-offset", name: "field.focus.ring.offset", ref: "semantic.focus.ring.offset", fallback: .string("2px")),
        ],
        "variant_idle": [
            "field.color.border": FsdsComponentTokenDefinition(cssVar: "--fsds-field-color-border", name: "field.color.border", ref: "semantic.color.border.subtle", fallback: .adaptive(light: "#d0d0d0", dark: "#474647")),
        ],
