...
enum DetailsTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "details.size.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-details-size-padding-default", name: "details.size.padding.default", ref: "core.spacing.size.06", fallback: .string("16px")),
            ...
            "details.focus.ring.width": FsdsComponentTokenDefinition(cssVar: "--fsds-details-focus-ring-width", name: "details.focus.ring.width", ref: "semantic.shape.control.border.focusWidth", fallback: .string("2px")),
            "details.focus.ring.color": FsdsComponentTokenDefinition(cssVar: "--fsds-details-focus-ring-color", name: "details.focus.ring.color", ref: "semantic.color.border.accent", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "details.focus.ring.offset": FsdsComponentTokenDefinition(cssVar: "--fsds-details-focus-ring-offset", name: "details.focus.ring.offset", ref: "core.spacing.size.02", fallback: .string("2px")),
            "details.spacing.gap.default": FsdsComponentTokenDefinition(cssVar: "--fsds-details-spacing-gap-default", name: "details.spacing.gap.default", ref: "core.spacing.size.02", fallback: .string("2px")),
            "details.typography.lineHeight.body": FsdsComponentTokenDefinition(cssVar: "--fsds-details-typography-line-height-body", name: "details.typography.lineHeight.body", ref: "semantic.typography.line.height.body", fallback: .string("1.5")),
            "details.typography.fontWeight.medium": FsdsComponentTokenDefinition(cssVar: "--fsds-details-typography-font-weight-medium", name: "details.typography.fontWeight.medium", ref: "semantic.typography.font.weight.medium", fallback: .string("500")),
            "details.size.padding.compact": FsdsComponentTokenDefinition(cssVar: "--fsds-details-size-padding-compact", name: "details.size.padding.compact", ref: "core.spacing.size.04", fallback: .string("8px")),
            "details.size.padding.page": FsdsComponentTokenDefinition(cssVar: "--fsds-details-size-padding-page", name: "details.size.padding.page", ref: "core.spacing.size.07", fallback: .string("24px")),
            "details.typography.fontSize.body": FsdsComponentTokenDefinition(cssVar: "--fsds-details-typography-font-size-body", name: "details.typography.fontSize.body", ref: "semantic.typography.body.03", fallback: .string("14px")),
        ...
        "variant_compact": [
            ...
            "details.typography.lineHeight.body": FsdsComponentTokenDefinition(cssVar: "--fsds-details-typography-line-height-body", name: "details.typography.lineHeight.body", ref: "core.spacing.size.06", fallback: .string("16px")),
        ],
        "variant_inline": [
