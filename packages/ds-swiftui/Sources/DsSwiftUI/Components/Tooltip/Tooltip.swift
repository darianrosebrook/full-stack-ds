...
enum TooltipTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "tooltip.size.padding.y": FsdsComponentTokenDefinition(cssVar: "--fsds-tooltip-size-padding-y", name: "tooltip.size.padding.y", ref: "core.spacing.size.03", fallback: .string("4px")),
            "tooltip.size.padding.x": FsdsComponentTokenDefinition(cssVar: "--fsds-tooltip-size-padding-x", name: "tooltip.size.padding.x", ref: "core.spacing.size.04", fallback: .string("8px")),
            ...
            "tooltip.typography.fontSize": FsdsComponentTokenDefinition(cssVar: "--fsds-tooltip-typography-font-size", name: "tooltip.typography.fontSize", ref: "semantic.typography.caption.01", fallback: .string("14px")),
            "tooltip.layer.content": FsdsComponentTokenDefinition(cssVar: "--fsds-tooltip-layer-content", name: "tooltip.layer.content", ref: "core.layer.tooltip", fallback: .string("1800")),
        ],
    ]
}
