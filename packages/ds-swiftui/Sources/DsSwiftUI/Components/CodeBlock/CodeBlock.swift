...
enum CodeBlockTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "code-block.token.color.plain": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-plain", name: "code-block.token.color.plain", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "code-block.token.color.comment": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-comment", name: "code-block.token.color.comment", fallback: .adaptive(light: "#474647", dark: "#a0a0a1")),
            "code-block.token.color.keyword": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-keyword", name: "code-block.token.color.keyword", fallback: .adaptive(light: "#013ab0", dark: "#00a9fb")),
            "code-block.token.color.definition": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-definition", name: "code-block.token.color.definition", fallback: .adaptive(light: "#900909", dark: "#ee8181")),
            "code-block.token.color.punctuation": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-punctuation", name: "code-block.token.color.punctuation", fallback: .adaptive(light: "#013ab0", dark: "#00a9fb")),
            "code-block.token.color.property": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-property", name: "code-block.token.color.property", fallback: .adaptive(light: "#6c3a00", dark: "#ec8802")),
            "code-block.token.color.static": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-static", name: "code-block.token.color.static", fallback: .adaptive(light: "#900909", dark: "#ee8181")),
            "code-block.token.color.string": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-string", name: "code-block.token.color.string", fallback: .adaptive(light: "#900909", dark: "#ee8181")),
            "code-block.token.color.tag": FsdsComponentTokenDefinition(cssVar: "--fsds-code-block-token-color-tag", name: "code-block.token.color.tag", fallback: .adaptive(light: "#900909", dark: "#ee8181")),
        ],
    ]
}
