...
enum ProfileFlagTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "profile-flag.color.background.default": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-color-background-default", name: "profile-flag.color.background.default", fallback: .adaptive(light: "#ffffff", dark: "#000000")),
            "profile-flag.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-color-border-default", name: "profile-flag.color.border.default", fallback: .adaptive(light: "#b8b8b8", dark: "#474647")),
            "profile-flag.color.foreground.primary": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-color-foreground-primary", name: "profile-flag.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "profile-flag.size.radius.default": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-size-radius-default", name: "profile-flag.size.radius.default", fallback: .string("6px")),
            "profile-flag.spacing.gap.default": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-spacing-gap-default", name: "profile-flag.spacing.gap.default", fallback: .string("4px")),
            "profile-flag.spacing.padding.default": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-spacing-padding-default", name: "profile-flag.spacing.padding.default", fallback: .string("8px")),
            "profile-flag.spacing.padding.right": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-spacing-padding-right", name: "profile-flag.spacing.padding.right", fallback: .string("16px")),
            "profile-flag.color.border.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-profile-flag-color-border-hover", name: "profile-flag.color.border.hover", fallback: .adaptive(light: "#888889", dark: "#727272")),
        ],
    ]
}
