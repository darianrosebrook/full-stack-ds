...
enum NavListTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "nav-list.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-color-background-hover", name: "nav-list.color.background.hover", ref: "semantic.color.background.subtle", fallback: .adaptive(light: "#f7f7f7", dark: "#313131")),
