...
enum NavListTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "nav-list.color.foreground.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-color-foreground-hover", name: "nav-list.color.foreground.hover", ref: "semantic.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "nav-list.color.foreground.current": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-color-foreground-current", name: "nav-list.color.foreground.current", ref: "semantic.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            ...
            "nav-list.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-color-background-hover", name: "nav-list.color.background.hover", ref: "semantic.color.background.subtle", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            "nav-list.stateLayer.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-state-layer-hover", name: "nav-list.stateLayer.hover", ref: "semantic.interaction.stateLayer.hover", fallback: .string("0.04")),
            "nav-list.stateLayer.selected": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-state-layer-selected", name: "nav-list.stateLayer.selected", ref: "semantic.interaction.stateLayer.selected", fallback: .string("0.08")),
            "nav-list.color.background.current": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-color-background-current", name: "nav-list.color.background.current", ref: "semantic.color.background.accentSubtle", fallback: .adaptive(light: "#95dafb", dark: "#002782")),
            "nav-list.color.outline.focus": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-color-outline-focus", name: "nav-list.color.outline.focus", ref: "semantic.color.border.accent", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "nav-list.size.padding.block": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-size-padding-block", name: "nav-list.size.padding.block", ref: "core.spacing.size.02", fallback: .string("2px")),
            "nav-list.size.padding.inline": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-size-padding-inline", name: "nav-list.size.padding.inline", ref: "core.spacing.size.04", fallback: .string("8px")),
            ...
            "nav-list.size.gap.list": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-size-gap-list", name: "nav-list.size.gap.list", ref: "core.spacing.size.01", fallback: .string("1px")),
            "nav-list.size.gap.group": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-size-gap-group", name: "nav-list.size.gap.group", ref: "core.spacing.size.04", fallback: .string("8px")),
            "nav-list.size.fontSize.item": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-size-font-size-item", name: "nav-list.size.fontSize.item", ref: "semantic.typography.body.03", fallback: .string("14px")),
            "nav-list.size.fontSize.groupLabel": FsdsComponentTokenDefinition(cssVar: "--fsds-nav-list-size-font-size-group-label", name: "nav-list.size.fontSize.groupLabel", ref: "semantic.typography.caption.03", fallback: .string("10px")),
        ],
    ]
}
