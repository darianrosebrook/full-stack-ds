...
enum PostcardTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "postcard.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-postcard-color-background-hover", name: "postcard.color.background.hover", ref: "semantic.color.background.secondary", fallback: .adaptive(light: "#f7f7f7", dark: "#313131")),
