...
enum SkeletonTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "skeleton.color.base": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-color-base", name: "skeleton.color.base", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            "skeleton.color.highlight": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-color-highlight", name: "skeleton.color.highlight", fallback: .adaptive(light: "#f5a2a1", dark: "#900909")),
            "skeleton.color.static": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-color-static", name: "skeleton.color.static", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            "skeleton.radius.sm": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-sm", name: "skeleton.radius.sm", fallback: .string("4px")),
            "skeleton.radius.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-md", name: "skeleton.radius.md", fallback: .string("8px")),
            "skeleton.radius.lg": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-lg", name: "skeleton.radius.lg", fallback: .string("16px")),
            "skeleton.radius.full": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-full", name: "skeleton.radius.full", fallback: .string("9999px")),
            "skeleton.gap.compact": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-gap-compact", name: "skeleton.gap.compact", fallback: .string("4px")),
            "skeleton.gap.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-gap-md", name: "skeleton.gap.md", fallback: .string("12px")),
            "skeleton.gap.spacious": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-gap-spacious", name: "skeleton.gap.spacious", fallback: .string("24px")),
            "skeleton.anim.duration": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-anim-duration", name: "skeleton.anim.duration", fallback: .string("400ms")),
            "skeleton.anim.easing": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-anim-easing", name: "skeleton.anim.easing", fallback: .string("cubic-bezier(0.4, 0, 0.2, 1)")),
            "skeleton.shape.height.text": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-shape-height-text", name: "skeleton.shape.height.text", fallback: .string("1rem")),
        ],
        "variant_block": [
            "skeleton.radius.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-md", name: "skeleton.radius.md", fallback: .string("8px")),
        ],
        "variant_text": [
            "skeleton.radius.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-md", name: "skeleton.radius.md", fallback: .string("4px")),
            "skeleton.shape.height.text": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-shape-height-text", name: "skeleton.shape.height.text", fallback: .string("1rem")),
        ],
        "variant_avatar": [
            "skeleton.radius.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-md", name: "skeleton.radius.md", fallback: .string("9999px")),
        ],
        "variant_media": [
            "skeleton.radius.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-radius-md", name: "skeleton.radius.md", fallback: .string("8px")),
        ],
        ...
        "variant_wipe": [
            "skeleton.color.base": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-color-base", name: "skeleton.color.base", fallback: .adaptive(light: "#b8b8b8", dark: "#474647")),
        ],
        "variant_compact": [
            "skeleton.gap.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-gap-md", name: "skeleton.gap.md", fallback: .string("4px")),
        ],
        "variant_regular": [
            "skeleton.gap.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-gap-md", name: "skeleton.gap.md", fallback: .string("12px")),
        ],
        "variant_spacious": [
            "skeleton.gap.md": FsdsComponentTokenDefinition(cssVar: "--fsds-skeleton-gap-md", name: "skeleton.gap.md", fallback: .string("24px")),
        ],
    ]
}
