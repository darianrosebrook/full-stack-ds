...
enum StatTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "stat.color.foreground.value": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-color-foreground-value", name: "stat.color.foreground.value", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "stat.color.foreground.label": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-color-foreground-label", name: "stat.color.foreground.label", fallback: .adaptive(light: "#474647", dark: "#a0a0a1")),
            "stat.color.foreground.trend.up": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-color-foreground-trend-up", name: "stat.color.foreground.trend.up", fallback: .adaptive(light: "#497f21", dark: "#5b973c")),
            "stat.color.foreground.trend.down": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-color-foreground-trend-down", name: "stat.color.foreground.trend.down", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "stat.color.foreground.trend.neutral": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-color-foreground-trend-neutral", name: "stat.color.foreground.trend.neutral", fallback: .adaptive(light: "#474647", dark: "#a0a0a1")),
            "stat.size.value.sm": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-size-value-sm", name: "stat.size.value.sm", fallback: .string("18px")),
            "stat.size.value.md": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-size-value-md", name: "stat.size.value.md", fallback: .string("24px")),
            "stat.size.value.lg": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-size-value-lg", name: "stat.size.value.lg", fallback: .string("32px")),
            "stat.size.label": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-size-label", name: "stat.size.label", fallback: .string("12px")),
            "stat.size.gap": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-size-gap", name: "stat.size.gap", fallback: .string("2px")),
            ...
            "stat.typography.weight.value": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-typography-weight-value", name: "stat.typography.weight.value", fallback: .string("700")),
            "stat.typography.weight.label": FsdsComponentTokenDefinition(cssVar: "--fsds-stat-typography-weight-label", name: "stat.typography.weight.label", fallback: .string("500")),
        ],
    ]
}
