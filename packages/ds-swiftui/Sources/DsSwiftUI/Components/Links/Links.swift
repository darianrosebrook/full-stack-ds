...
enum LinksTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "links.color.foreground.default": FsdsComponentTokenDefinition(cssVar: "--fsds-links-color-foreground-default", name: "links.color.foreground.default", fallback: .adaptive(light: "#d92d2e", dark: "#e55b5a")),
            "links.color.foreground.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-links-color-foreground-hover", name: "links.color.foreground.hover", fallback: .adaptive(light: "#b31b1b", dark: "#ee8181")),
            "links.color.foreground.visited": FsdsComponentTokenDefinition(cssVar: "--fsds-links-color-foreground-visited", name: "links.color.foreground.visited", fallback: .adaptive(light: "#e55b5a", dark: "#d92d2e")),
            "links.color.foreground.disabled": FsdsComponentTokenDefinition(cssVar: "--fsds-links-color-foreground-disabled", name: "links.color.foreground.disabled", fallback: .adaptive(light: "#727272", dark: "#888889")),
            "links.color.underline.default": FsdsComponentTokenDefinition(cssVar: "--fsds-links-color-underline-default", name: "links.color.underline.default", fallback: .adaptive(light: "#b8b8b8", dark: "#474647")),
            ...
            "links.focus.ring.color": FsdsComponentTokenDefinition(cssVar: "--fsds-links-focus-ring-color", name: "links.focus.ring.color", fallback: .adaptive(light: "#0566fe", dark: "#0566fe")),
