...
enum TabsTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "tabs.color.hover.bg": FsdsComponentTokenDefinition(cssVar: "--fsds-tabs-color-hover-bg", name: "tabs.color.hover.bg", ref: "semantic.color.background.hover", fallback: .adaptive(light: "#f7f7f7", dark: "#474647")),
            ...
            "tabs.color.active-bg": FsdsComponentTokenDefinition(cssVar: "--fsds-tabs-color-active-bg", name: "tabs.color.active-bg", ref: "semantic.color.background.secondary", fallback: .adaptive(light: "#f7f7f7", dark: "#313131")),
