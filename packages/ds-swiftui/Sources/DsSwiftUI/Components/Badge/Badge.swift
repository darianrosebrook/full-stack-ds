...
enum BadgeTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "badge.color.background.default": FsdsComponentTokenDefinition(cssVar: "--fsds-badge-color-background-default", name: "badge.color.background.default", ref: "semantic.color.background.secondary", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            "badge.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-badge-color-background-hover", name: "badge.color.background.hover", ref: "semantic.interaction.background.hover", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
