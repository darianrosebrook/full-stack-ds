...
enum InputTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "input.color.bg.default": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-bg-default", name: "input.color.bg.default", fallback: .string("#ffffff")),
            "input.color.bg.disabled": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-bg-disabled", name: "input.color.bg.disabled", fallback: .string("#b8b8b8")),
            "input.color.text.default": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-text-default", name: "input.color.text.default", fallback: .string("#141414")),
            "input.color.text.placeholder": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-text-placeholder", name: "input.color.text.placeholder", fallback: .string("#888889")),
            "input.color.text.disabled": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-text-disabled", name: "input.color.text.disabled", fallback: .string("#727272")),
            "input.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-border-default", name: "input.color.border.default", fallback: .string("#a0a0a1")),
            "input.color.border.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-border-hover", name: "input.color.border.hover", fallback: .string("#888889")),
            "input.color.border.disabled": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-border-disabled", name: "input.color.border.disabled", fallback: .string("#b8b8b8")),
            ...
            "input.color.focus.default": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-focus-default", name: "input.color.focus.default", fallback: .string("#0566fe")),
            "input.color.invalid.default": FsdsComponentTokenDefinition(cssVar: "--fsds-input-color-invalid-default", name: "input.color.invalid.default", fallback: .string("#b31b1b")),
            ...
            "input.focus.ring.color": FsdsComponentTokenDefinition(cssVar: "--fsds-input-focus-ring-color", name: "input.focus.ring.color", fallback: .string("#0566fe")),
