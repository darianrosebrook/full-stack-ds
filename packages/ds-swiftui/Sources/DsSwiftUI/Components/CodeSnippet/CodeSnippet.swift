...
enum CodeSnippetTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "code-snippet.color.background.default": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-color-background-default", name: "code-snippet.color.background.default", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            "code-snippet.color.foreground.primary": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-color-foreground-primary", name: "code-snippet.color.foreground.primary", fallback: .adaptive(light: "#141414", dark: "#fafafa")),
            "code-snippet.color.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-color-border-default", name: "code-snippet.color.border.default", fallback: .adaptive(light: "#d0d0d0", dark: "#474647")),
            "code-snippet.size.padding.inline": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-size-padding-inline", name: "code-snippet.size.padding.inline", fallback: .string("2px")),
            "code-snippet.size.padding.block": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-size-padding-block", name: "code-snippet.size.padding.block", fallback: .string("1px")),
            "code-snippet.size.radius.default": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-size-radius-default", name: "code-snippet.size.radius.default", fallback: .string("6px")),
            "code-snippet.size.border.default": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-size-border-default", name: "code-snippet.size.border.default", fallback: .string("1px")),
            "code-snippet.size.fontSize.default": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-size-font-size-default", name: "code-snippet.size.fontSize.default", fallback: .string("0.875rem")),
            "code-snippet.typography.lineHeight.default": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-typography-line-height-default", name: "code-snippet.typography.lineHeight.default", fallback: .string("1.5")),
            "code-snippet.elevation.kbd": FsdsComponentTokenDefinition(cssVar: "--fsds-code-snippet-elevation-kbd", name: "code-snippet.elevation.kbd", fallback: .string("0px 1px 2px #0000000f, 0px 1px 3px #0000001a")),
        ],
    ]
}
