...
enum TableTokens {
    public static let scopes: FsdsComponentTokenScopes = [
        "root": [
            ...
            "table.color.background.footer": FsdsComponentTokenDefinition(cssVar: "--fsds-table-color-background-footer", name: "table.color.background.footer", ref: "semantic.color.background.secondary", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            ...
            "table.color.background.hover": FsdsComponentTokenDefinition(cssVar: "--fsds-table-color-background-hover", name: "table.color.background.hover", ref: "semantic.interaction.background.hover", fallback: .adaptive(light: "#d0d0d0", dark: "#313131")),
            "table.color.background.selected": FsdsComponentTokenDefinition(cssVar: "--fsds-table-color-background-selected", name: "table.color.background.selected", ref: "semantic.color.background.accent", fallback: .adaptive(light: "#d92d2e", dark: "#d92d2e")),
