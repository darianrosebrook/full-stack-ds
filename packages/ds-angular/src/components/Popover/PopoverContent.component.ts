...
import { PopoverContextToken } from "./usePopover.js";
import {
...
export class PopoverContentComponent implements AfterViewInit, OnDestroy, DoCheck {
  ...
  @HostBinding("attr.data-popover-content") get _dataMarker(): string | null {
