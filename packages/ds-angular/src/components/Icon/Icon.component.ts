...
@Component({
  ...
  template: `<span [ngClass]="classes()" [attr.role]="((decorative ?? true) ? 'presentation' : 'img')" [attr.aria-hidden]="((decorative ?? true) ? 'true' : 'false')" [attr.aria-label]="ariaLabel" data-fsds-box="">
