...
export class AnchoredSurfaceController extends SurfaceController {
  ...
  private installDismissal(): void {
    ...
    // catches focus leaving any descendant. Angular's substrate has
    // no handlerMode — the anchor element is always owned and
    // registered by the trigger component or directive, so we
