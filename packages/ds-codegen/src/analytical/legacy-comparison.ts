...
const DISPOSITION: Record<string, string> = {
  ...
  "delete-holder:scalar>absent:legacy-invalid":
    "legacy deleted the required child and left the holder missing a property the schema demands -- a source-invalid image -- while the new plan deletes the HOLDER, which is the only state in which a required child's presence varies. The legacy image asserted a partial declaration the representation cannot express; the new image is the lawful forgetting of the coordinate's degree of freedom.",
